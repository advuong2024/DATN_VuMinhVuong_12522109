    ...
    >
      <div>
        <img
          ...
          alt="logo"
          style={{ width: 160, marginBottom: 30, display: "block", marginLeft: "auto", marginRight: "auto" }}
        />
        ...
        {step === 1 && (
          <div style={{ width: 520 }}>
            ...
            >
              <Checkbox style={{ fontSize: 20, color: "#1890ff" }}>
                Remember me
              </Checkbox>
            </div>
      ...
      <Text style={{ marginTop: 110, fontSize: 16 }}>
